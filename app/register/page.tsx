        ...
        <div className={'bg-cover bg-center h-screen w-full bg-[url(/assets/images/login-bg.jpg)]'}>
          ...
          <div className={'relative w-full h-screen flex justify-center items-center'}>
            <Card className={'w-[380px] px-5'}>
              <CardHeader>
                <CardTitle className={'text-2xl text-center mb-3'}>Safe Exam Register</CardTitle>
              ...
              <CardFooter className={'gap-x-3 flex-col items-start'}>
                <div className="flex gap-x-3 w-full">
                  <Button id="button-register" className="w-full">Register</Button>
                  <Button asChild={true} id="button-login" className="w-full" variant="secondary">
